...
| Operator chrome (presented user) and soft-bind (1 X→1 Nostr, many X on one key) | [architecture.md § Operator binding](architecture.md#operator-binding-x--nostr) · [architecture.md § The presented user](architecture.md#the-presented-user) |
