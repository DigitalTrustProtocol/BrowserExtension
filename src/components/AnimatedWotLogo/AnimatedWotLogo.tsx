...
export default function AnimatedWotLogo({ size = 96 }: AnimatedWotLogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
      ...
      <circle cx={24} cy={24} r={5} fill="rgb(13,148,136)" />
        ...
        return (
          <g key={i}>
            ...
            <line
              ...
              stroke="rgba(13,148,136,0.5)" strokeWidth="1.5"
            ...
            <circle
              ...
              fill="rgba(13,148,136,0.9)" opacity="0"
            >
              ...
              return (
                <g key={j}>
                  ...
                  <circle
                    ...
                    fill="rgba(13,148,136,0.6)" opacity="0"
                  >
